            ...
            <section className="mb-16">
              <h2 className="text-3xl font-bold text-white mb-8 text-center">
                <span className="inline-flex items-center">
                  <RocketLaunchIcon style={{ width: '24px', height: '24px', marginRight: '32px' }} className="text-orange-400" />
                  Quick Start
                </span>
              </h2>
...
# Access at http://localhost:3003`}
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-bold text-white mb-8 text-center">
                <span className="inline-flex items-center">
                  <ComputerDesktopIcon style={{ width: '24px', height: '24px', marginRight: '32px' }} className="text-orange-400" />
                  Web Dashboard Guide
                </span>
              </h2>
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-bold text-white mb-8 text-center">
                <span className="inline-flex items-center">
                  <WrenchScrewdriverIcon style={{ width: '24px', height: '24px', marginRight: '32px' }} className="text-orange-400" />
                  Configuration
                </span>
              </h2>
...
ADMIN_TOKEN=your_admin_token`}
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-bold text-white mb-8 text-center">
                <span className="inline-flex items-center">
                  <CommandLineIcon style={{ width: '24px', height: '24px', marginRight: '32px' }} className="text-orange-400" />
                  CLI & API (Optional)
                </span>
              </h2>
...
curl http://localhost:3100/api/wallets/1/balance`}
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-bold text-white mb-8 text-center">
                <span className="inline-flex items-center">
                  <CloudArrowUpIcon style={{ width: '24px', height: '24px', marginRight: '32px' }} className="text-orange-400" />
                  Production Deployment
                </span>
              </h2>
    ...
    location /api {
        ...
        proxy_set_header X-Real-IP $remote_addr;
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-bold text-white mb-8 text-center">
                <span className="inline-flex items-center">
                  <ShieldCheckIcon style={{ width: '24px', height: '24px', marginRight: '32px' }} className="text-orange-400" />
                  Troubleshooting
                </span>
              </h2>
...
sqlite3 ./data/treasury.db ".tables"`}
            ...
            <section className="mb-16">
              <h2 className="text-3xl font-bold text-white mb-8 text-center">
                <span className="inline-flex items-center">
                  <DocumentTextIcon style={{ width: '24px', height: '24px', marginRight: '32px' }} className="text-orange-400" />
                  Next Steps
                </span>
              </h2>
